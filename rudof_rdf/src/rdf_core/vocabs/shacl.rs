...
vocab_term!(ShaclVocab, SH_NODE_KIND_CONSTRAINT_COMPONENT, "NodeKindConstraintComponent");
vocab_term!(ShaclVocab, SH_CLASS_CONSTRAINT_COMPONENT, "ClassConstraintComponent");
vocab_term!(ShaclVocab, SH_DATATYPE_CONSTRAINT_COMPONENT, "DatatypeConstraintComponent");

vocab_term!(ShaclVocab, SH_DEACTIVATED_CONSTRAINT_COMPONENT, "DeactivatedConstraintComponent");
...
vocab_term!(ShaclVocab, SH_DISJOINT_CONSTRAINT_COMPONENT, "DisjointConstraintComponent");
vocab_term!(ShaclVocab, SH_EQUALS_CONSTRAINT_COMPONENT, "EqualsConstraintComponent");
vocab_term!(ShaclVocab, SH_LESS_THAN_CONSTRAINT_COMPONENT, "LessThanConstraintComponent");
vocab_term!(ShaclVocab, SH_LESS_THAN_OR_EQUALS_CONSTRAINT_COMPONENT, "LessThanOrEqualsConstraintComponent");

vocab_term!(ShaclVocab, SH_CLOSED_CONSTRAINT_COMPONENT, "ClosedConstraintComponent");
vocab_term!(ShaclVocab, SH_HAS_VALUE_CONSTRAINT_COMPONENT, "HasValueConstraintComponent");
vocab_term!(ShaclVocab, SH_IN_CONSTRAINT_COMPONENT, "InConstraintComponent");

vocab_term!(ShaclVocab, SH_PATTERN_CONSTRAINT_COMPONENT, "PatternConstraintComponent");
vocab_term!(ShaclVocab, SH_LANGUAGE_IN_CONSTRAINT_COMPONENT, "LanguageInConstraintComponent");
vocab_term!(ShaclVocab, SH_MIN_LENGTH_CONSTRAINT_COMPONENT, "MinLengthConstraintComponent");
vocab_term!(ShaclVocab, SH_MAX_LENGTH_CONSTRAINT_COMPONENT, "MaxLengthConstraintComponent");
vocab_term!(ShaclVocab, SH_UNIQUE_LANG_CONSTRAINT_COMPONENT, "UniqueLangConstraintComponent");

vocab_term!(ShaclVocab, SH_MIN_COUNT_CONSTRAINT_COMPONENT, "MinCountConstraintComponent");
vocab_term!(ShaclVocab, SH_MAX_COUNT_CONSTRAINT_COMPONENT, "MaxCountConstraintComponent");

vocab_term!(ShaclVocab, SH_MIN_INCLUSIVE_CONSTRAINT_COMPONENT, "MinInclusiveConstraintComponent");
vocab_term!(ShaclVocab, SH_MIN_EXCLUSIVE_CONSTRAINT_COMPONENT, "MinExclusiveConstraintComponent");
vocab_term!(ShaclVocab, SH_MAX_INCLUSIVE_CONSTRAINT_COMPONENT, "MaxInclusiveConstraintComponent");
vocab_term!(ShaclVocab, SH_MAX_EXCLUSIVE_CONSTRAINT_COMPONENT, "MaxExclusiveConstraintComponent");

vocab_term!(ShaclVocab, SH_NODE_CONSTRAINT_COMPONENT, "NodeConstraintComponent");
vocab_term!(ShaclVocab, SH_QUALIFIED_VALUE_SHAPE_CONSTRAINT_COMPONENT, "QualifiedValueShapeConstraintComponent");
vocab_term!(ShaclVocab, SH_QUALIFIED_MIN_COUNT_CONSTRAINT_COMPONENT, "QualifiedMinCountConstraintComponent");
vocab_term!(ShaclVocab, SH_QUALIFIED_MAX_COUNT_CONSTRAINT_COMPONENT, "QualifiedMaxCountConstraintComponent");
vocab_term!(ShaclVocab, SH_REIFIER_SHAPE_CONSTRAINT_COMPONENT, "ReifierShapeConstraintComponent"); // SHACL 1.2
