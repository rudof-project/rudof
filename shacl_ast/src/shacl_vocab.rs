...
lazy_static! {
   ...
   pub static ref SH_BLANK_NODE_OR_LITERAL: IriS = IriS::new_unchecked(SH_BLANK_NODE_OR_LITERAL_STR);
   ...
   pub static ref SH_QUALIFIED_VALUE_SHAPE: IriS = IriS::new_unchecked(SH_QUALIFIED_VALUE_SHAPE_STR);
   pub static ref SH_QUALIFIED_VALUE_SHAPES_DISJOINT: IriS = IriS::new_unchecked(SH_QUALIFIED_VALUE_SHAPES_DISJOINT_STR);
   ...
   pub static ref SH_SOURCE_CONSTRAINT_COMPONENT: IriS = IriS::new_unchecked(SH_SOURCE_CONSTRAINT_COMPONENT_STR);
