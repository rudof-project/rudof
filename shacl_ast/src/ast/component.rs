use crate::ast::node_expr::NodeExpr;
...
impl<RDF: Rdf> Clone for Component<RDF> {
    fn clone(&self) -> Self {
        match self {
            ...
            Component::MinLength(m) => Component::MinLength(*m),
            Component::MaxLength(m) => Component::MaxLength(*m),
            Component::Pattern { pattern, flags } => Component::Pattern {
                pattern: pattern.clone(),
                flags: flags.clone(),
            },
            Component::UniqueLang(u) => Component::UniqueLang(*u),
            Component::LanguageIn(langs) => Component::LanguageIn(langs.clone()),
            ...
            Component::Or(shapes) => Component::Or(shapes.clone()),
            Component::And(shapes) => Component::And(shapes.clone()),
            Component::Not(shape) => Component::Not(shape.clone()),
            Component::Xone(shapes) => Component::Xone(shapes.clone()),
            Component::Closed {
                is_closed,
                ignored_properties,
            } => Component::Closed {
            ...
            Component::Node(shape) => Component::Node(shape.clone()),
            Component::HasValue(value) => Component::HasValue(value.clone()),
            Component::In(values) => Component::In(values.clone()),
            Component::QualifiedValueShape {
                shape,
                disjoint,
                siblings,
...
impl<RDF: Rdf> PartialEq for Component<RDF> {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            (Component::LanguageIn(l), Component::LanguageIn(r)) => l == r,
            ...
            (Component::Or(l), Component::Or(r)) => l == r,
            (Component::And(l), Component::And(r)) => l == r,
            (Component::Not(l), Component::Not(r)) => l == r,
            (Component::Xone(l), Component::Xone(r)) => l == r,
            (
                Component::Closed {
                    is_closed: cl,
            ...
            (Component::Node(l), Component::Node(r)) => l == r,
            (Component::HasValue(l), Component::HasValue(r)) => l == r,
            (Component::In(l), Component::In(r)) => l == r,
            (
                Component::QualifiedValueShape {
                    shape: sl,
                    q_min_count: minl,
