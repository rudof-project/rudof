...
fn generate_first_name(rng: &mut impl Rng, locale: &str) -> String {
    let names = match locale {
        "es" => &[
            "Alejandro", "Ana", "Antonio", "Carmen", "Carlos", "Cristina", "Diego", "Elena", 
            "Fernando", "Isabel", "Javier", "Laura", "Manuel", "María", "Miguel", "Pilar",
            "Rafael", "Rosa", "Sergio", "Teresa"
        ],
        "fr" => &[
            "Alexandre", "Alice", "Antoine", "Catherine", "Charles", "Christine", "David", "Élise",
            "François", "Isabelle", "Jacques", "Julie", "Louis", "Marie", "Michel", "Nicole",
            "Pierre", "Sophie", "Thomas", "Valérie"
        ],
        _ => &[
            "Alexander", "Alice", "Andrew", "Catherine", "Charles", "Christine", "David", "Elizabeth",
            "Frank", "Isabella", "James", "Julia", "Michael", "Maria", "Robert", "Nicole",
            "Peter", "Sophie", "Thomas", "Victoria"
        ],
    };
