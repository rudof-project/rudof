...
impl<R: Rdf + Clone + 'static, E: Engine<R>> NativeValidator<R, E> for Node<R> {
    fn validate_native(
        &self,
...
impl<S: Rdf + Sparql + Clone + 'static> SparqlValidator<S> for Node<S> {
    fn validate_sparql(
        &self,
