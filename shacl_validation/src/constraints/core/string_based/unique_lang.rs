...
impl<R: Rdf + 'static, E: Engine<R>> NativeValidator<R, E> for UniqueLang {
    fn validate_native(
        &self,
        ...
        let unique_lang = |value_node: &Object<R>| {
...
impl<S: Rdf + Sparql + 'static> SparqlValidator<S> for UniqueLang {
    fn validate_sparql(
        &self,
