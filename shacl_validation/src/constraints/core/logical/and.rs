...
impl<R: Rdf + Clone + 'static, E: Engine<R>> NativeValidator<R, E> for And<R> {
    fn validate_native(
        &self,
        ...
        let and = |value_node: &TObjectRef<R>| {
...
impl<S: Rdf + Sparql + Clone + 'static> SparqlValidator<S> for And<S> {
    fn validate_sparql(
        &self,
