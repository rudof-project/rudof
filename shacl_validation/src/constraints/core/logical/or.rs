...
impl<R: Rdf + Clone + 'static, E: Engine<R>> NativeValidator<R, E> for Or<R> {
    fn validate_native(
        &self,
        ...
        let or = |value_node: &TObjectRef<R>| {
...
impl<S: Rdf + Sparql + Clone + 'static> SparqlValidator<S> for Or<S> {
    fn validate_sparql(
        &self,
