use crate::{
    ...
    formats::{InputSpec, ShaclFormat, DataFormat},
};
use std::str::FromStr;
...
fn test_extract_shacl_shapes_from_loaded_data() {
    ...
    load_data(&mut rudof, Some(&[data_with_shapes]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
...
fn test_extract_shacl_shapes_mixed_data() {
    ...
    load_data(&mut rudof, Some(&[mixed_data]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
...
fn test_extract_shacl_shapes_from_data_no_shapes() {
    ...
    load_data(&mut rudof, Some(&[data_no_shapes]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
...
fn test_extract_and_serialize_complex_shapes() {
    ...
    load_data(&mut rudof, Some(&[complex_data]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
...
fn test_extract_shapes_then_load_separate_schema() {
    ...
    load_shacl_schema(&mut rudof, Some(&separate_schema), Some(&ShaclFormat::Turtle), None, None).unwrap();
...
fn test_extract_shacl_shapes_with_lists() {
    ...
    load_data(&mut rudof, Some(&[data_with_lists]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
...
fn test_extract_shapes_multiple_data_sources() {
    ...
    load_data(&mut rudof, Some(&[data_source1, data_source2]), Some(&DataFormat::Turtle), None, None, None, Some(true)).unwrap();
...
fn test_extract_shapes_with_merge() {
    ...
    load_data(&mut rudof, Some(&[data_source1]), Some(&DataFormat::Turtle), None, None, None, None).unwrap();
    ...
    load_data(&mut rudof, Some(&[data_source2]), Some(&DataFormat::Turtle), None, None, None, Some(true)).unwrap();
