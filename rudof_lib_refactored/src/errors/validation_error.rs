...
pub enum ValidationError {
    ...
    #[error("Unsupported ShEx validation sort by mode: '{mode}'. Valid options are: 'node', 'shape', 'status', 'details'")]
    UnsupportedShExValidationSortByMode { mode: String },

    /// The SHACL validation result sorting mode is not supported by Rudof.
    #[error("Unsupported SHACL validation sort by mode: '{mode}'. Valid options are: 'severity', 'node', 'component', 'value', 'path', 'sourceshape', 'details'")]
    UnsupportedShaclValidationSortByMode { mode: String },

    /// The validation result format is not supported by Rudof.
    #[error("Unsupported validation result format: '{format}'. Valid formats are: 'turtle', 'ntriples', 'rdfxml', 'trig', 'n3', 'nquads', 'compact', 'details', 'json', 'csv'")]
    UnsupportedValidationResultFormat { format: String },

    /// The ShEx validation result format is not supported by Rudof.
    #[error("Unsupported ShEx validation result format: '{format}'. Valid formats are: 'turtle', 'ntriples', 'rdfxml', 'trig', 'n3', 'nquads', 'compact', 'details', 'json', 'csv'")]
    UnsupportedShExValidationResultFormat { format: String },

    /// RDF-based formats cannot be converted to ShapeMap format.
    #[error("Cannot convert format '{format}' to ShapeMap format. Only 'compact', 'details', 'json', and 'csv' are supported for ShapeMap conversion")]
    ...
    #[error("Cannot convert format '{format}' to Property Graph schema validation format. Only 'compact', 'details', 'json', and 'csv' are supported for Property Graph schema validation conversion")]
    ...
    #[error("Unsupported SHACL validation result format: '{format}'. Valid formats are: 'turtle', 'ntriples', 'rdfxml', 'trig', 'n3', 'nquads', 'minimal', 'compact', 'details', 'json', 'csv'")]
    ...
    #[error("Unsupported Property Graph schema validation result format: '{format}'. Valid formats are: 'compact', 'details', 'json', 'csv'")]
    UnsupportedPgSchemaValidationResultFormat { format: String },
}