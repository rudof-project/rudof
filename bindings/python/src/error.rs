    ...
    ($name:ident, $base:ty, $doc:literal) => {
        ...
        impl ::pyo3_stub_gen::PyStubType for $name {
            fn type_output() -> ::pyo3_stub_gen::TypeInfo {
                ::pyo3_stub_gen::TypeInfo::with_module(stringify!($name), ::pyo3_stub_gen::ModuleRef::Default)
            }
        }
...
impl From<Error> for PyErr {
    fn from(Error(e): Error) -> Self {
        ...
        let err = match e.as_ref() {
            ...
            CoreError::Query(_) | CoreError::UnsupportedResultQueryFormatSelect { .. } => QueryError::new_err(msg),
