...
- [USDA - United States Department of Agriculture](https://www.usda.gov/) is using `rudof` to develop Data Shapes based on [National Agricultural Library Thesaurus Concept Space](https://lod.nal.usda.gov/en/).
