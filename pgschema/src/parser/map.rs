...
pub struct MapParser<'i, I: InputT + ?Sized, L: Lexer<'i, Context<'i, I>, State, TokenKind, Input = I>, B>(
    LRParser<'i, Context<'i, I>, State, ProdKind, TokenKind, NonTermKind, MapParserDefinition, L, B, I>,
);
#[allow(dead_code)]
impl<'i>
    MapParser<
            ...
            ProdKind::Association1P2 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Association(p0)) => {
                        NonTerminal::Association1(map_actions::association1_association(context, p0))
                    },
                    _ => panic!("Invalid symbol parse stack data."),
                }
            },
