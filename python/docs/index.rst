...
.. code-block:: python
    ...
    result = rudof.validate_shacl(ShaclValidationMode.Native, ShapesGraphSource.CurrentSchema)
...
.. code-block:: python
    ...
    from pyrudof import GeneratorConfig, DataGenerator, OutputFormat
...
.. code-block:: python
    ...
    result = rudof.run_query_construct_str("""
        ...
        CONSTRUCT { ?p wdt:P31 wd:Q5 }
        WHERE { ?p wdt:P31 wd:Q5 }
        LIMIT 5
