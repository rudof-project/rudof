...
use crate::validation::constraints::get_shape_from_idx;
...
use crate::validation::validator::focus_nodes_ops::FocusNodesOps;
use crate::validation::validator::value_nodes_ops::ValueNodesOps;

/// Validate RDF data using SHACL
pub(crate) trait Validate<RDF: Rdf> {
    fn validate(
        &self,
        store: &RDF,
