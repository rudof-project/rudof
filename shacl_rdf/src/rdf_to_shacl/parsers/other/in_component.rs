...
pub(crate) fn in_component<RDF: FocusRDF>() -> impl RDFNodeParse<RDF, Output = Vec<Component<RDF>>> {
...
fn cnv_in_list<RDF: Rdf>(ls: Vec<RDF::Term>) -> Result<Component<RDF>, RDFError> {
    let values = ls
        .iter()
