...
use rudof_lib::{Rudof, RudofConfig, formats::{DataFormat, DataReaderMode, InputSpec, ResultShExValidationFormat, ShExFormat, ShapeMapFormat}};
            ...
            group.bench_with_input(
                ...
                |b, case| {
                    b.iter(|| {
                        ...
                        // Stage 1 + 2 + 3
                        rudof.load_shex_schema(&InputSpec::path(&case.schema_path))
                        ...
                        rudof.load_shapemap(&InputSpec::path(&case.shapemap_path))
                        ...
                        let mut buf = Vec::new();
                        rudof.serialize_shex_validation_results(&mut buf)
